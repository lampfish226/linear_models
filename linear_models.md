...
Could just fit separate models. (filter certain borough but fit is the
same)
...
Using `map()` function: choose a column first, and choose the function
you want to apply
